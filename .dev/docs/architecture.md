# Архитектура приложения Arbor

## Обзор

Arbor — React/Remix приложение для создания карт знаний. Архитектура построена на **Feature-Sliced Design (FSD)** с адаптациями под специфику проекта.
