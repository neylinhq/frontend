...
import type { ChatMessage, PreviewCard, QuickActionType, EnrichmentPreviewData, ExercisePreviewData } from '../ai-assist.types'
...
export const AIChatPanel = ({ nodeId, mapId, quickActions = ['enrich', 'examples', 'sources', 'exercises'] }: AIChatPanelProps) => {
  ...
  const handleSavePreview = async (messageId: string, previewCard: PreviewCard) => {
    try {
      ...
      } else if (previewCard.type === 'exercises') {
        // Handle exercises save
        toast({
