...
// Edge colors by relation type (using CSS variables from globals.css)
 ...
 */
export const EdgeOverlay = memo(
  function EdgeOverlay({ edge, sourceX, sourceY, targetX, targetY, zoom }: EdgeOverlayProps) {
    ...
    const _arrowX = targetX - (dx / distance) * arrowOffset
    const _arrowY = targetY - (dy / distance) * arrowOffset
