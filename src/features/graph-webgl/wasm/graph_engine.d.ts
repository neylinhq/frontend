...
export interface InitOutput {
  ...
  readonly graphengine_load_font_atlas_data: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly graphengine_load_icon_atlas_data: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly graphengine_load_sdf_atlas_data: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly graphengine_run_layout: (
    a: number,
    b: number,
    c: number
  ...
  readonly graphengine_update_node_position: (
    a: number,
    b: number,
    c: number,
    d: number,
