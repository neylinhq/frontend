...
export const graphengine_load_font_atlas_data: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const graphengine_load_icon_atlas_data: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const graphengine_load_sdf_atlas_data: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const graphengine_run_layout: (
  a: number,
  b: number,
  c: number
...
export const graphengine_update_node_position: (
  a: number,
  b: number,
  c: number,
  d: number,
