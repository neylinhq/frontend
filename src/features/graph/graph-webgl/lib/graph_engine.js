...
const GraphEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class GraphEngine {
     ...
     * @param {string} json
     */
    set_render_params(json) {
        const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.graphengine_set_render_params(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} node_ids
     */
    set_selected_nodes(node_ids) {
        const ptr0 = passStringToWasm0(node_ids, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.graphengine_set_selected_nodes(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    hit_test_edge_badge(screen_x, screen_y) {
        const ret = wasm.graphengine_hit_test_edge_badge(this.__wbg_ptr, screen_x, screen_y);
        let v1;
        if (ret[0] !== 0) {
    ...
    load_font_atlas_data(image_data, width, height, metrics_json) {
        ...
        const ptr1 = passStringToWasm0(metrics_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.graphengine_load_font_atlas_data(this.__wbg_ptr, ptr0, len0, width, height, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    load_icon_atlas_data(image_data, width, height, icons_json) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.graphengine_load_icon_atlas_data(this.__wbg_ptr, ptr0, len0, width, height, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} metrics_json
     */
    load_bitmap_atlas_data(image_data, width, height, metrics_json) {
        const ptr0 = passArray8ToWasm0(image_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(metrics_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.graphengine_load_bitmap_atlas_data(this.__wbg_ptr, ptr0, len0, width, height, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    set_dpr(dpr) {
        wasm.graphengine_set_dpr(this.__wbg_ptr, dpr);
    }
    /**
