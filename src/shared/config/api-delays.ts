...
export const API_DELAYS = {
  ...
  SUBSCRIPTION_GET_PAYMENT_METHODS: 700,
  SUBSCRIPTION_ADD_PAYMENT_METHOD: 1000,
  SUBSCRIPTION_REMOVE_PAYMENT_METHOD: 800,
  SUBSCRIPTION_SET_DEFAULT_PAYMENT: 600,
  SUBSCRIPTION_GET_PAYMENT_HISTORY: 900,
